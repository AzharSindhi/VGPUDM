...
if __name__ == '__main__':
    ...
    parser.add_argument('--point-output-dir', type=str, default="../datasets/ModelNet10_singleview_2048/", help="generated_single_view_pcd")
    parser.add_argument('--depth-output-dir', type=str, default="../datasets/ModelNet10_singleview_depth_2048/", help="generated_single_view_depth")
    parser.add_argument('--input-dir', type=str, default="/home/ez48awud/Documents/datasets/ModelNet10/ModelNet10/", help="generated_single_view_pcd")
    parser.add_argument('--number-points', type=int, default=1024, help="generated_single_view_pcd")
